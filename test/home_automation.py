...
temp_logo=PhotoImage(file='005-solar.png')
...
left_frame=Frame(root,bg='#17202A',borderwidth=5,highlightbackground="green",highlightthickness=1)
left_frame.pack(side=LEFT,anchor=NW,fill=X,expand=True,ipady=10)
right_frame= Frame(root,bg='#17202A')
right_frame.pack(side=RIGHT,anchor=NW,fill=X,expand=1)
home_frame= LabelFrame(left_frame,bg='#6D8AA7')
home_frame.grid(row=1,column=0,sticky=W,columnspan=3)
right1=Frame(right_frame,bg='#17202A')
right1.grid(row=0,column=0,sticky='NW')
right2=Frame(right_frame,bg='#17202A')
right2.grid(row=1,column=0,sticky='NW',ipady=10)
right3=Frame(right_frame,bg='#17202A')
right3.grid(row=2,column=0,sticky='NW',ipady=10)


# ################################# Frame creations ends here         ################################


text1=Label(left_frame,text="Smart Home (Raayathon 7)",anchor='w',font="Verdana 20 bold",pady=30,bg='#17202A',fg='#EFF094')
text1.grid(row=0,column=0,sticky='w',columnspan=3)
text2=Label(home_frame,image=room_1,bg='#D1F2EB')
text2.grid(row=0,column=0,sticky='w',ipadx=100,ipady=10)
text3=Label(home_frame,text="All devices",anchor='c',font="Verdana 20 bold",padx=30,pady=30,bg='#D1F2EB')
...
def temperature():
    ...
    lb4 = Label(right3, font=('calibri', 30, 'bold'), fg='#EFF094',bg='#17202A', text="Hyderabad      "+str(coordinate1)+"  "+str(coordinate2), compound="right",image=map_logo)
    lb4.grid(row=0, column=0,sticky='nw')

    lb2 = Label(right3, font=('calibri', 30, 'bold'), fg='#EFF094',bg='#17202A',text="Temperature  "+str(temp), compound="right",image=temp_logo)
    lb2.grid(row=1, column=0, sticky='nw')
    lb3 = Label(right3, font=('calibri', 30, 'bold'), fg='#EFF094',bg='#17202A',text="Humidity         "+str(humidity), compound="right",image=humidity_logo)
    lb3.grid(row=2, column=0, sticky='nw')

    lb7 = Label(right3, font=('calibri', 30, 'bold'), fg='#EFF094',bg='#17202A',text="Wind Speed    "+str(wind_speed), compound="right",image=wind_logo)
    lb7.grid(row=3, column=0,sticky='nw')
...
lbl = Label(left_frame, font=('calibri', 30, 'bold'),background='#81BDE6',bg='#17202A',fg='#EFF094')
lbl.grid(row=0,column=3,columnspan=3,sticky='ne')
